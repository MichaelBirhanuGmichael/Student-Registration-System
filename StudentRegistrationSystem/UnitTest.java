...
class UnitTest {
    ...
    void generateCourseTable() {
        ...
        Student student = new Student("John Doe", "4965/14","Software Engineering", 1, 2);
    ...
    void testStudentConstructorAndGetters() {
        // Create a sample student
        Student student = new Student("John Doe", "12345", "Software Engineering", 2, 1);

        // Validate the constructor and getters
        assertEquals("John Doe", student.getName());
        assertEquals("1324/14", student.getId());
